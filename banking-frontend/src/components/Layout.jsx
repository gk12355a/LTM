...
export default function Layout({ children }) {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-bold text-white">Banking<span className="text-gradient">App</span></span>
        </div>
      </div>
      ...
      <div className="px-6 py-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-white/40">Tài khoản cá nhân</p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex w-64 flex-col glass-card rounded-none border-r border-white/10 border-l-0 border-t-0 border-b-0">
        <SidebarContent />
      </aside>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden" onClick={() => setMobileOpen(false)}>
          ...
          <aside className="absolute left-0 top-0 bottom-0 w-64 z-50" style={{ background: 'rgba(18, 18, 26, 0.98)', borderRight: '1px solid rgba(255,255,255,0.1)' }} onClick={e => e.stopPropagation()}>
            <SidebarContent />
          </aside>
        </div>
      )}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Mobile Header */}
        <header className="lg:hidden flex items-center gap-3 px-4 py-4 border-b border-white/10">
